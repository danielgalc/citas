...
<body>
    ...
    if (isset($codigo, $password)) {
        if ($usuario = \App\Tablas\Usuario::comprobar($codigo, $password)) {
            // Loguear al usuario
    ...
    <div class="container mx-auto">
        ...
        <div class="mx-72">
            <form action="" method="POST">
                <div class="mb-6">
                    <label for="codigo" class="block mb-2 text-sm font-medium <?= $clases_label ?>">Nombre de usuario</label>
                    <input type="text" name="codigo" class="border text-sm rounded-lg block w-full p-2.5 <?= $clases_input ?>">
                    <?php if ($error): ?>
